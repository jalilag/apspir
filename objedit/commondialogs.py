...
class NodeInfosDialog(wx.Dialog):
    ...
    def _init_coll_MainSizer_Items(self, parent):
        ...
        parent.AddWindow(self.Suffixe, 0, border=0, flag=wx.GROW)
    ...
    def _init_ctrls(self, prnt):
        wx.Dialog.__init__(self, id=ID_NODEINFOSDIALOG,
              name='NodeInfosDialog', parent=prnt, pos=wx.Point(400, 223),
              size=wx.Size(300, 280), style=wx.DEFAULT_DIALOG_STYLE,
              title=_('Node infos'))
        self.SetClientSize(wx.Size(300, 350))
        ...
        self.staticText6 = wx.StaticText(id=ID_NODEINFOSDIALOGSTATICTEXT6,
              label=_('Suffixe:'), name='staticText6', parent=self,
              pos=wx.Point(0, 0), size=wx.Size(10, 17), style=0)

        self.Suffixe = wx.TextCtrl(id=ID_NODEINFOSDIALOGSUFFIXE, 
              name='Suffixe', parent=self, pos=wx.Point(0, 0), 
              size=wx.Size(0, 24), style=0, value="")
    ...
    def SetValues(self, name, id, type, description, defaultstringsize,suff):
    ...
    def GetValues(self):
        ...
        suffixe = self.Suffixe.GetValue()
        return name, nodeid, type, description, defaultstringsize, suffixe
