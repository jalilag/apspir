...
def GenerateFileContent(Node, headerfilepath,add_id, pointers_dict = {}):
    """
...
#-------------------------------------------------------------------------------
    ...
    for index in listIndex:
        ...
        if not isinstance(values, ListType):
            ...
            if index in variablelist:
                texts["name"] = UnDigitName(FormatName(subentry_infos["name"])) + add_id
            ...
            if entry_infos["struct"] & OD_IdenticalSubindexes:
                ...
                if index in variablelist:
                    texts["name"] = UnDigitName(FormatName(entry_infos["name"])) + add_id
...
def GenerateFile(filepath, node, pointers_dict = {}, add_id = ''):
    try:
